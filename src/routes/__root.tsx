...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Vanij orchestrates parallel autonomous coding agents into a single distributed engineering runtime." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Vanij — Autonomous AI Engineering Runtime" },
      { name: "twitter:description", content: "Vanij orchestrates parallel autonomous coding agents into a single distributed engineering runtime." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/cd6795e6-c7ff-4c8a-9058-41dd3a0f256f/id-preview-a438875a--30d1adfc-2b8a-4199-b523-99187bc10537.lovable.app-1779552884798.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/cd6795e6-c7ff-4c8a-9058-41dd3a0f256f/id-preview-a438875a--30d1adfc-2b8a-4199-b523-99187bc10537.lovable.app-1779552884798.png" },
    ],
    links: [
